...
const PROBLEMATICS_API = "/api/generate-problematics";
const PLANS_API = "/api/generate-plans";
const INTRO_PREVIEW_API = "/api/generate-introduction-preview";
const BLOCK_API = "/api/generate-block";
