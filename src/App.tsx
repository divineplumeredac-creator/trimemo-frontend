            ...
            {view === "preview" && preview && (
              <div className="grid gap-6 lg:grid-cols-3">
                <section className="rounded-[24px] border border-[#172554]/5 bg-white p-7">
                  ...
                  {preview.problematic.rationale && <div className="mt-5 rounded-[14px] bg-[#EAF7EE] p-4 font-inter text-[12px] leading-[1.6] text-[#172554]/75">{preview.problematic.rationale}</div>}
                </section>
                <section className="rounded-[24px] border border-[#172554]/5 bg-white p-7">
                  ...
                  <div className="mt-5 space-y-3">
                    <div className="rounded-[12px] bg-[#EAF7EE] p-3">
                    ...
                    {preview.plan.parts.map((part) => <div key={part.id} className="rounded-[12px] border border-[#172554]/10 p-3">
                      ...
                      <div className="mt-2 space-y-2">
                        {part.chapters.map((chapter) => <div key={chapter.id} className="rounded-[10px] bg-[#EAF7EE] p-3">
